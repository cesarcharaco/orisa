...
class CommandsController extends Controller
{
    ...
    public function eleccion($eleccion)
    {
        if($eleccion == 1){
            $platos = Plate::all();
    ...
    public function getClient($documento)
    {
        $client = Client::where('dni_cedula', $documento)->get();
    ...
    public function store(Request $request)
    {
      ...
      if($request->comanda_id){
        ...
        Flash::success('<strong>Exito </strong> la comanda se registro correctamente');
    ...
    public function ready($id)
    {
      ...
      $jugos = $comanda->juices()->get();
        ...
        Flash::success('<strong>Éxito </strong> la comanda'.$comanda->id.' esta lista, el mesonero ya fue notificado');
    ...
    */
    ...
    public function process_invoice(Request $request){
        ...
        Flash::success('<strong>Éxito </strong> Se ha procesado la comanda correctamente');
