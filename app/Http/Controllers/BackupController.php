...
class BackupController extends Controller
{
    ...
    {     
        ...
        if($disk =  Storage::disk('backup')->exists($request->id))
        {
            $delete = Storage::disk('backup')->delete($request->id);
    ...
    public function restoreFalse()
    {

        return view('admin.backups.restore', compact('backups'));
    }

    public function downloadFalse()
    {
        $fs = "../storage/local/" . $file_name;
        return response()->download($fs);
    }
