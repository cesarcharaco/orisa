...
class BeveragesController extends Controller
{
    ...
    {
        $beverages = Beverage::orderBy('trago')->get();
    ...
    public function store(Request $request)
    {
        ...
        Flash::success('<strong>Éxito </strong> el trago '. $beverage->trago .' se creo correctamente.');
    ...
    public function update(Request $request, $id)
    {
      ...
      Flash::success('<strong>Éxito </strong> el trago '. $beverage->trago .' se modifico correctamente.');
