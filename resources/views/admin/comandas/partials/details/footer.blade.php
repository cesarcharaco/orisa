<div class="panel-footer">
  @if($comanda->estatus == 'En espera' AND (Sentinel::getUser()->roles()->first()->slug =='1') || (Sentinel::getUser()->roles()->first()->slug =='4'))
    ...
    <a class="btn btn-default btn-xs" href="{{ route('admin.comandas.lista', $comanda->id) }}"  data-toggle="tooltip" data-placement="right" title="Lista"><span class="fa fa-bell fa-2x"></span></a>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a class="btn btn-default btn-xs" href="{{ route('admin.comandas.add', $comanda->id) }}" data-toggle="tooltip" data-placement="right" title="Agregar"><span class="fa fa-plus-circle fa-2x"></span></a>
  @endif
