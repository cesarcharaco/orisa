...
<div class="form-group{{ $errors->has('ingrediente') ? ' has-error' : '' }} has-feedback">
	...
	{!! Form::text('ingrediente', null, ['class' => 'form-control requerido', 'placeholder' => 'Harina P.A.N', 'title' => 'Ingrese el ingrediente', 'required', 'disabled']) !!}
...
<div class="form-group{{ $errors->has('id_type') ? ' has-error' : '' }} has-feedback">
	...
	{!! Form::select('id_type', $ingredients_types, null, ['placeholder' => 'Seleccione', 'class' => 'form-control select', 'required', 'disabled']) !!}
...
<div class="form-group{{ $errors->has('caracteristica') ? ' has-error' : '' }} has-feedback">
    ...
    {!! Form::text('caracteristica', null, ['class' => 'form-control requerido', 'placeholder' => 'Maíz blanco', 'title' => 'Introduzca una característica del producto', 'required', 'disabled']) !!} 
...
<div class="form-group tooltip-demo text-center hide">
	...
	<a class="btn btn-default btn-sm" href="{{ url('admin/ingredientes') }}" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Cancelar"><span class="glyphicon glyphicon-floppy-remove fa-2x"></span></a>
	<br>
</div> 