            ...
            @foreach($planificacion as $planning_list)
                <tr>
                    ...
                    <td class="text-center tooltip-demo">
                        <a class="btn btn-default btn-xs" href="#" type="button" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Eliminar" onclick="planificacion({{ $planning_list->planificacion_id }}, {{ $planning_list->ems->id }})"><span class="glyphicon glyphicon-trash fa-x" data-toggle="modal"  data-target="#myModal"></span></a>
                    </td>
                </tr>
            @endforeach 
        @endforeach
