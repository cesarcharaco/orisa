...
<div class="col-lg-12">
	...
	<div class="form-group has-feedback">
		...
		{!! Form::text('nombre', null, ['class' => 'form-control nombre requerido', 'placeholder' => 'Ej. Alfredo Jesús', 'title' => 'Introduzca su nombre', 'required']) !!}
	...
	<div class="form-group has-feedback">
		...
		<div class="form-inline has-feedback form-group">
			...
			{!! Form::text('telefono', null, [ 'maxlength' => '7', 'class' => 'form-control telefono awesome requerido numerico', 'placeholder' => 'Ej. 4968557', 'maxlength' => '7', 'title' => 'Introduzca su número de teléfono', 'required']) !!}
	...
	<div class="form-group has-feedback">
		...
		{!! Form::text('correo', null, ['class' => 'form-control requerido correo', 'placeholder' => 'Ej. nombre@mail.com', 'title' => 'Introduzca su correo electrónico', 'required']) !!}
            <span class="help-block">
                <em><small></small></em>
           	</span>
	...
	<div class="form-group has-feedback ">
		...
		{!! Form::text('ciudad', null, ['class' => 'form-control requerido', 'placeholder' => 'Ej. Cagua', 'title' => 'Introduzca en nombre de la cuidad', 'required']) !!}
	...
	<div class="form-group has-feedback ">
		...
		{!! Form::text('calle', null, ['class' => 'form-control requerido', 'placeholder' => 'Ej. Calle 5 de marzo', 'title' => 'Introduzca el nombre de la calle o avenida', 'required']) !!}
	...
	<div class="form-group has-feedback ">
		...
		{!! Form::text('habitacion', null, ['class' => 'form-control requerido', 'placeholder' => 'Ej. Apartamento 08-04', 'title' => 'Introduzca el numero de habitación', 'required']) !!}
	...
	<div class="form-group tooltip-demo text-center">
		<button class="btn btn-default btn-sm" type="submit" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Guardar"><span class="glyphicon glyphicon-floppy-saved fa-2x"></span></button>
			...
			<button class="btn btn-default btn-sm" type="reset" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Borrar">
