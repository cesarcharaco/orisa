...
<div class="form-group{{ $errors->has('licor') ? ' has-error' : '' }} has-feedback">
	...
	{!! Form::text('licor', null, ['class' => 'form-control requerido', 'placeholder' => 'Belvedere', 'title' => 'Introduzca el nombre del licor', 'required']) !!}
...
<div class="form-group{{ $errors->has('type_id') ? ' has-error' : '' }} has-feedback">
	...
	{!! Form::select('type_id', $liqueurs_types, null, ['placeholder' => 'Seleccione', 'class' => 'form-control requerido select', 'required']) !!}
...
<div class="form-group{{ $errors->has('id_unit') ? ' has-error' : '' }} has-feedback">
	...
	{!! Form::select('id_unit', $units, null, ['placeholder' => 'Seleccione', 'class' => 'form-control requerido select', 'required']) !!}
...
<div class="form-group{{ $errors->has('caracteristica') ? ' has-error' : '' }} has-feedback">
    ...
    {!! Form::text('caracteristica', null, ['class' => 'form-control requerido', 'placeholder' => 'Pomelo rosa', 'title' => 'Introduzca una característica del producto', 'required']) !!} 
