...
<div class="form-group{{ $errors->has('bebida') ? ' has-error' : '' }} has-feedback">
	...
	{!! Form::text('bebida', null, ['class' => 'form-control requerido', 'placeholder' => 'Yukery', 'title' => 'Ingrese el nombre de la bebida', 'required']) !!}
...
<div class="form-group{{ $errors->has('caracteristica') ? ' has-error' : '' }} has-feedback">
    ...
    {!! Form::text('caracteristica', null, ['class' => 'form-control requerido', 'placeholder' => 'Jugos Yuky-Pak', 'title' => 'Introduzca una característica del producto', 'required']) !!} 
