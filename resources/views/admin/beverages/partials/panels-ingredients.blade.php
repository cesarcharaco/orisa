		...
		<div class="panel-body">
			...
			<div class="row">
				...
				<div class="col-md-6" role="presentation">
					<a class="btn btn-default btn-sm"  href="#licores" aria-controls="profile" role="tab" data-toggle="tab" onclick="anterior(2)">
						<span class="glyphicon glyphicon-circle-arrow-left"></span>
					</a>
				</div>
				<div class="col-md-6 text-right">
					<a class="btn btn-default btn-sm"  href="#trago" aria-controls="profile" role="tab" data-toggle="tab" onclick="siguiente(2)">
