...
<div class="row">
    ...
    <div class="col-lg-4">
        <a  href="{{ url('admin/jugos/create') }}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Nuevo">
              ...
              <div class="col-md-4">
                <div class="panel panel-default">
                  <div class="panel-body">
                    <img src="../img/juices/{{ $juice->image->imagen }}" alt="" class="img-responsive" style="max-height: 150px">
                  </div>
